...
const PersonDetails = () => {
  ...
  useEffect(() => {
    ...
    // console.log(asyncloadperson(id))
    return () => {
  ...
  return info ? (
    <div className="px-[5%] w-screen h-full bg-[#1F1E24] ">
      {/* Part 1 navigation */}
      <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl ">
        <Link
          onClick={() => navigate(-1)}
          className="hover:text-[#6556CD] ri-arrow-left-line"
        ><span className="p-2">Back</span></Link>
      </nav>
      ...
      <div className="w-full flex max-sm:flex-col  ">
        ...
        <div className="w-[80%] ml-[5%]">
          ...
          <div className="list-disc text-zinc-400 w-full h-[50vh] mt-5 overflow-x-hidden overflow-y-auto shadow-xl shadow-[rgba(0,0,0,.9)] border-2 border-zinc-700 p-5">
